...
public class Test 
{
	...
	//	Set s=new HashSet();															// Wrong It Remove All previous relationship and add new and only single relation between two row.		
	...
	public static void Get_Parent_Childs(int TID) throws Exception
	{
