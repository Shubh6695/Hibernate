...
public class Test 
{
	...
	public static void Insert_ONE_TO_MANY() throws Exception
	{
		...
		tdto.setTeamcountry("England");
		
		tdto.setTeamsport("FootBoll");
...
*/									
	...
	public static void  Delete_Child_MANY_TO_ONE(int PID) throws Exception
	{
	...
	public static void Update_Parent_MANY_TO_ONE(int TID) throws Exception
	{
		...
		while(itr.hasNext())
		{
			...
			if(pdto.getTeamParent().getTeamid() == TID)
			{
				...
				pdto.getTeamParent().setTeamsport("Hockey");
				
				
				sess.update(pdto);
				
				
				System.out.println("Team NEW Details");
	...
	//	Update_Parent_MANY_TO_ONE(1001);									
