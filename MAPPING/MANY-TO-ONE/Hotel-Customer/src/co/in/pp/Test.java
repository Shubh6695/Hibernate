...
public class Test 
{
	...
	public static void UpdateParent(int HID) throws Exception
	{
		...
		while(itr.hasNext())
		{
			...
			if(cdto.getHotelParent().getHotelid() == HID)
			{
				
				
				System.out.println("OLD Parent Detail's");
				
				
				System.out.println(cdto.getHotelParent().getHotelid()+"\t"+cdto.getHotelParent().getHotelname()+"\t"+cdto.getHotelParent().getHotelemail()+"\t"+
				
						cdto.getHotelParent().getHotelcity()+"\t"+cdto.getHotelParent().getHotelcity()+"\t"+cdto.getHotelParent().getHotelrating());
				...
				cdto.getHotelParent().setHotelrating(3.5f);
				...
				System.out.println("NEW Parent Detail's");
