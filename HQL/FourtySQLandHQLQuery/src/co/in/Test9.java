...
public class Test9
{
	...
	// Query 9 :- select * from studetails where roll_no IN (1001, 1005)
	...
	public static void SQLQUERY() throws Exception
	{
		...
		Query s1=s.createSQLQuery("select * from studetails where roll_no IN (1001, 1005)");
	...
	public static void HQLQUERY() throws Exception
	{
		...
		Query h1=s.createQuery("from StudentDTO where rollno IN (1001, 1005)");
