...
public class Test13 {
	...
	// Query 13 :- select * from studetails where  PHYSICS > 30 and CHEMISTRY > 30 and MATHS > 30
	...
	public static void SQLQUERY() throws Exception
	{
		...
		Query s1=s.createSQLQuery("select * from studetails where  PHYSICS > 30 and CHEMISTRY > 30 and MATHS > 30");
	...
	public static void HQLQUERY() throws Exception
	{
		...
		Query h1=s.createQuery("from StudentDTO where physics > 30 and chemistry > 30 and maths > 30");
