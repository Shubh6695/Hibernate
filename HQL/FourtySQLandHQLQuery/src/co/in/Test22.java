...
//Query 22:- Select * from studetails where NOT S_NAME='shubham'; 
...
public class Test22 {
	...
	public static void SQLQUERY() throws Exception
	{
		...
		Query s1=s.createSQLQuery("select * from studetails where NOT S_NAME='shubham'");
	...
	public static void HQLQUERY() throws Exception
	{
		...
		Query h1=s.createQuery("from StudentDTO where NOT name='Shubham'");
