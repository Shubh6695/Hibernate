...
// Query 11 :- SELECT * FROM studetails GROUP BY MATHS ORDER BY maths DESC; 
	...
	public static void SQLQUERY() throws Exception
	{
		...
		Query s1=s.createSQLQuery("SELECT * FROM studetails GROUP BY MATHS order by maths desc ");
	...
	Query h1=s.createQuery("from StudentDTO group by maths order by maths desc");
