...
//Query 23:- SELECT * FROM studetails WHERE S_NAME IS NULL; 
...
public class Test23 {
	...
	public static void SQLQUERY() throws Exception
	{
		...
		Query s1=s.createSQLQuery("select * from studetails where S_NAME IS NULL");
	...
	public static void HQLQUERY() throws Exception
	{
		...
		Query h1=s.createQuery("from StudentDTO where name IS NULL");
