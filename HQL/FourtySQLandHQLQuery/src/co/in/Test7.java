...
public class Test7 {
	...
	// Query 7 :- select * from studetails where roll_no between 1001 and 1005
	...
	public static void SQLQUERY() throws Exception
	{
		...
		Query s1=s.createSQLQuery("select * from studetails where roll_no between 1001 and 1005");
	...
	public static void HQLQUERY() throws Exception
	{
		...
		Query h1=s.createQuery("from StudentDTO where rollno between 1001 and 1005");
