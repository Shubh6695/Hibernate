...
/*		while(itr2.hasNext())
		{
			...
			System.out.println(rollno+"\t"+fname+"\t"+lname+"\t"+total+"\t"+avg+"\t"+status);
	...
	*/	
		...
		while(itr2.hasNext())
		{
			...
			Integer total=(Integer) columns1[0];
	
			Float avg=(Float) columns1[1];
			
			String status=(String) columns1[2];
			
			
		
			System.out.println(total+"\t"+avg+"\t"+status);
