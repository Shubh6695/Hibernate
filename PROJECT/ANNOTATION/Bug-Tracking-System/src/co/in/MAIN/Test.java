		...
		if(flag==true)
		{
			...
			if(flag1==true)
			{
				...
				while(itr5.hasNext())
				{
					...
					System.out.println(count2+"\t"+employee.getFname()+"\t"+employee.getLname()+"\t"+employee.getRole());
...
/*								System.out.println("\n Bug is Already assign to Employee no :--"+bugstatus.getEid() +"\n");
...
*/								
								...
								System.out.println(" \n \n Bug is Successfully Assign to Employee  "+efname + elname);
		...
		//	sc.nextLine();
			...
			if(flag==true)
			{
				...
				if(flag2==true)
				{
					...
					}																							// while loop close(itr3)	
					
					ts.commit();
					
					System.out.println("\n MileStone Added Successfully ");
					
					sess.disableFilter("projectidequal");
				}																								// If close of flag2
	...
	public static void insertEmployeeMilestone() throws Exception
	{
		...
		Transaction ts=sess.beginTransaction();
			...
			System.out.println("Insert Milstone End-Date");
			...
			EmployeeMilestoneDTO mile=new EmployeeMilestoneDTO();
			
			mile.setEmname(mname);
			
			mile.setEmstartdate(start);
			
			mile.setEmenddate(end);
			...
			System.out.println("\n Insert no of Employee You Want to Assign Milestone \n");
		...
		System.out.println(" \n MileStone is successfully Assigned to all the given Employee");
	...
	public static void main(String[] args) throws Exception
	{
		...
		System.out.println("Insert 17 for Insert MileStone in Project \n");								// from ChatBugMain Class	
		
		System.out.println("Insert 18 for Insert Comment from Customer \n");							// from ChatBugMain Class
		
		System.out.println("Insert 19 for Insert Comment from Employee \n");							// from ChatBugMain Class
		
		System.out.println("Insert 20 for Forget Password \n");
		
		System.out.println("Insert 21 for Insert Milestone in Employee \n");
		...
		ChatBugMain c=new ChatBugMain();																// Create object of ChatBugMain Class	
		...
		else if(choice == 18)
		{
			...
			c.insertMessagefromCustomer();
			
		}																				// insert Message from Customer	

		
		else if(choice == 19)
		{
			
			c.insertMessageFromEmployee();
		...
		else if(choice== 21)
		{
			...
			insertEmployeeMilestone();
		}																				// insert Milestone in a Employee
		else
		{
